...
#include "../graphics/ShaderPrimitives/camerascene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CameraScene_t, stringdata) + ofs \
...
const QMetaObject CameraScene::staticMetaObject = {
    { &AbstractScene::staticMetaObject, qt_meta_stringdata_CameraScene.data,
      qt_meta_data_CameraScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CameraScene.stringdata))
